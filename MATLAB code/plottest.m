...
% Read data
data = xlsread('SCNN_MEAN_2011.csv', 'C3:N8762'); % Read temperature data
...
y = xlsread('SCNN_MEAN_2011.csv', 'A3:A8762'); % Optional additional data reading
...
title('(b) SCNN-LSTM prediction of temperature profile', 'FontSize', 10);
